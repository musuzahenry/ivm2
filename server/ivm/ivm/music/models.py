...
class MusicList(models.Model):
     artistID = models.ForeignKey(Artist, on_delete = models.CASCADE, null=True, blank=True)
     concertID = models.ForeignKey(Concert, on_delete=models.CASCADE, null=True, blank=True)
